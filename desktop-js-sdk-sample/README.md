...
This is a tutorial on how to use the Desktop JS SDK Library along with a Vanilla JS Web Component desktop widget. In this tutorial we are using a few methods like StateChange, addEventListeners and performing a few action on these events.
