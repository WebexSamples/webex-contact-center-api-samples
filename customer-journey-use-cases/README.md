...
- [Configure CJDS for your tenant](https://developer.webex.com/webex-contact-center/docs/journey-getting-started)
...
- You have already [Configure CJDS](https://developer.webex.com/webex-contact-center/docs/journey-getting-started) for your tenant <span style="font-size:12px;color:gray"> (Cisco based)</span>
