...
| agentSession query for ASR to fetch records where the filter is applied on isActive,channelType,teamName & siteName using compound operator "or" | [link](agentSession/Raw%20Data%20Fetching/binaryFilterOperation.graphql)                | [link](agentSession/Raw%20Data%20Fetching/binaryFilterOperation-response.json)                |
...
| agentSession query for ASR to fetch records where filter is applied on isActive  and channelType using compound operator "and" | [link](agentSession/Raw%20Data%20Fetching/Filtering%20using%20compound%20operators.graphql)                | [link](agentSession/Raw%20Data%20Fetching/Filtering%20using%20compound%20operators-response.json)                   |
...
| agentSession query with filter on channelType field within ChannelInfo object of ASR | [link](agentSession/Raw%20Data%20Fetching/Filtering%20on%20object%20types.graphql)                | [link](agentSession/Raw%20Data%20Fetching/Filtering%20on%20object%20types-response.json)                |
| agentSession query for filtering on staus field within the cahnnelInfo object of AAR | [link](agentSession/Raw%20Data%20Fetching/FitleringOnextFilter.graphql)                           | [link](agentSession/Raw%20Data%20Fetching/FilteringOnextFilter-response.json)                           |
...
| agentSession query for ASR where aggregation is applied on multiple fields of channelInfo object | [link](agentSession/Performing%20Aggregations/Aggregation%20query.graphql)    | [link](agentSession/Performing%20Aggregations/Aggregation%20query-response.json)      |
| agentSession query for AAR  where aggregation is applied on multiple fields of channelInfo object                                                               | [link](agentSession/Performing%20Aggregations/AggregationQueryForAAR.graphql) | [link](agentSession/Performing%20Aggregations/AggregationQueryForAAR-response.json)   |
...
| agentSession query for ASR where aggregation is applied on multiple fields of channelInfo object and aggregation interval is "DAILY" | [link](agentSession/Performing%20Aggregations/Interval%20timezone%20based%20aggregation%20query.graphql)            | [link](agentSession/Performing%20Aggregations/Interval%20timezone%20based%20aggregation%20query-response.json)            |
| agentSession query for AAR where aggregation is applied on "state" field  of channelInfo object and aggregation interval is "DAILY"  | [link](agentSession/Performing%20Aggregations/IntervalTimezoneBasedAggregationQueryForAAR.graphql)                  | [link](agentSession/Performing%20Aggregations/IntervalTimezoneBasedAggregationQueryForAAR-response.json)                  |
...
| agentSession query for ASR to retrieve the count of unique agentIds and teamIds where isActive is true.                                                                                                                      | [link](agentSession/Performing%20Aggregations/Aggregation%20global%20filter%20query.graphql)          | [link](agentSession/Performing%20Aggregations/Aggregation%20global%20filter%20query-response.json)          |
| agentSession query for AAR, fetch records where "state" field of channelInfo object is "connected" and perform an aggregation to count the number of connected events for each session based on unique channel activity Ids. | [link](agentSession/Performing%20Aggregations/AggregationQueryWithGlobalFilterForAAR.graphql)         | [link](agentSession/Performing%20Aggregations/AggregationQueryWithGlobalFilterForAAR-response.json)         |
...
| agentSession query for ASR where multiple aggregations are performed with a sub-filter on each | [link](agentSession/Performing%20Aggregations/Aggregation%20sub-filter%20query.graphql)          | [link](agentSession/Performing%20Aggregations/Aggregation%20sub-filter%20query-response.json)          |
| agentSession query for AAR  where multiple aggregations are performed with a sub-filter on each                                                                  | [link](agentSession/Performing%20Aggregations/AggregationQueryWithSubFilterForAAR.graphql)       | [link](agentSession/Performing%20Aggregations/AggregationQueryWithSubFilterForAAR-response.json)       |
...
| Query Type/ Record                                                                                                                     | Query                                                                                    | Response                                                                                          |
|----------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| agentSession ASR pagination query 1 sample to understand the usage of pageInfo object in the query, to fetch hasNextPage and endCursor | [link](agentSession/Raw%20Data%20Fetching/Pagination%20.graphql)                         | [link](agentSession%2FRaw%20Data%20Fetching%2FPagination%20-response.json)                        |
| agentSession ASR pagination query 2 sample to understand the usage of pageInfo object in the query, to fetch hasNextPage and endCursor | [link](agentSession/Raw%20Data%20Fetching/Pagination%202.graphql)                        | [link](agentSession%2FRaw%20Data%20Fetching%2FPagination%20-response.json)                        |
| agentSession ASR pagination query 3 sample to understand the usage of pageInfo object in the query, to fetch hasNextPage and endCursor | [link](agentSession/Raw%20Data%20Fetching/Pagination%203.graphql)                        | [link](agentSession/Raw%20Data%20Fetching/Pagination%203-response.json)                           |
...
| agentSession ASR aggregation query with pagination 1 sample to understand how Pagination is used  in a Group by Aggregation query   | [link](agentSession/Performing%20Aggregations/Aggregation%20Pagination.graphql)                           | [link](agentSession/Performing%20Aggregations/Aggregation%20Pagination%20-response.json)                          |
| agentSession ASR aggregation query with pagination 2 sample to understand how Pagination is used  in a Group by Aggregation query  | [link](agentSession/Performing%20Aggregations/Aggregation%20Pagination%202.graphql)                       | [link](agentSession/Performing%20Aggregations/Aggregation%20Pagination%202-response.json)                         |
| agentSession AAR aggregation query with pagination 1  sample to understand how Pagination is used  in a Group by Aggregation query | [link](agentSession/Performing%20Aggregations/AggregationPaginationQueryForAAR.graphql)                   | [link](agentSession/Performing%20Aggregations/AggregationPaginationQueryForAAR-response.json)                     |
| agentSession AAR aggregation query with pagination 2  sample to understand how Pagination is used  in a Group by Aggregation query | [link](agentSession/Performing%20Aggregations/AggregationPaginationQueryForAAR2.graphql)                  | [link](agentSession/Performing%20Aggregations/AggregationPaginationQueryForAAR2-response.json)                    |
